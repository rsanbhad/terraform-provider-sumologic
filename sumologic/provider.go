...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"sumologic_monitors_library_monitor_response": resourceSumologicMonitorsLibraryMonitorResponse(),

			"sumologic_monitors_library_monitor_update": resourceSumologicMonitorsLibraryMonitorUpdate(),
